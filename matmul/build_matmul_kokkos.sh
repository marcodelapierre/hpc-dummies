...
if [ $target == "setonix-gpu" ] ; then
  ...
  #does not build, not sure why (undefined references to cublas functions)
  ###Kernels_ROOT="/group/pawsey0001/mdelapierre/VISCOUS/kokkos-setup/kokkos-kernels/apps"
